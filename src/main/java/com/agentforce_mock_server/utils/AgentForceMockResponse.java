...
public class AgentForceMockResponse {
  ...
  public static final List<List<String>> technologyFiltersData =
      List.of(
          List.of(
              "Software", "Collaboration Tools", "Unified Communications", "Video Conferencing"),
          List.of("Software", "E-Commerce", "Online Marketplace", "Retail Management Software"),
          List.of(
              "Software", "Customer Relationship Management", "CRM Software", "Sales Automation"),
          List.of("Telecommunications", "5G Networks", "Wireless Infrastructure", "5G Towers"),
          List.of(
              "Business Services", "Logistics", "Supply Chain Management", "Inventory Tracking"),
  ...
  public static final List<List<String>> accountsData =
      List.of(
          ...
          List.of(
              ...
              "Wireless Communication",
              "+1-888-211-4727",
              "6200 Sprint Parkway, Overland Park, KS 66251, USA",
              "Kansas, USA"),
          List.of(
              "567890",
              "Comcast",
              ...
              "Cable & Internet",
              "+1-800-266-2278",
              "One Comcast Center, Philadelphia, PA 19103, USA",
              "Pennsylvania, USA"),
          List.of(
              "678901",
              "Cisco Systems",
